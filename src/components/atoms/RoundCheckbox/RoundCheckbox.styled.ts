...
export interface RoundCheckboxStyleProps {
  size: CheckSize;
  disabled?: boolean;
...
export const CheckboxWrapper = styled.button<RoundCheckboxStyleProps>`
  position: relative;
...
export const CheckIcon = styled(Check)<RoundCheckboxStyleProps>`
