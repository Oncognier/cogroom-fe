...
export const ERROR_CODE = {
  ...
  PRESENT_PAYMENT_METHOD_NOT_FOUND: 'PRESENT_PAYMENT_METHOD_NOT_FOUND',
};
...
export const PORTONE = {
  ...
  MYPAGE_IDENTITY_REDIRECT_URL: process.env.NEXT_PUBLIC_PORTONE_MYPAGE_IDENTITY_REDIRECT_URL,
